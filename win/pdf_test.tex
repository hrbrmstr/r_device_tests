...
\includegraphics{pdf_test_files/figure-latex/png-1.png}

\subsubsection{JPEG device}\label{jpeg-device}

\includegraphics{pdf_test_files/figure-latex/jpeg-1.jpeg}
...
\includegraphics{pdf_test_files/figure-latex/cairo_pdf-1.pdf}

\subsubsection{CAIROPDF device}\label{cairopdf-device}

\includegraphics{pdf_test_files/figure-latex/CairoPDF-1.pdf}
